...
scan_chain
"""
    # No usar /tmp/jtag_auto.cfg fijo: puede quedar creado por root y dar Permission denied.
    # Creamos un archivo único dentro del proyecto, donde el usuario que corre Flask tiene permiso.
    import tempfile
